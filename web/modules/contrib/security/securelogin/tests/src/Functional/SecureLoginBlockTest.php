...
class SecureLoginBlockTest extends SecureLoginTestBase {
  ...
  public function testUserLoginBlock(): void {
    ...
    $this->assertSession()->responseHeaderEquals('Location', str_replace('http://', 'https://', $base_url) . '/index.php/node');
    ...
    $this->assertSession()->statusCodeEquals(301);
    $this->assertSession()->responseHeaderEquals('Location', str_replace('http://', 'https://', $base_url) . '/index.php/admin');

    $this->drupalGet($this->httpUrl('admin/config'));
    $this->assertSession()->statusCodeEquals(301);
    $this->assertSession()->responseHeaderEquals('Location', str_replace('http://', 'https://', $base_url) . '/index.php/admin/config');

    $this->drupalGet($this->httpUrl('no-page-by-this-name'));
    $this->assertSession()->statusCodeEquals(301);
    $this->assertSession()->responseHeaderEquals('Location', str_replace('http://', 'https://', $base_url) . '/index.php/no-page-by-this-name');

    $this->drupalGet($this->httpUrl('nor-this-one'));
    $this->assertSession()->statusCodeEquals(301);
    $this->assertSession()->responseHeaderEquals('Location', str_replace('http://', 'https://', $base_url) . '/index.php/nor-this-one');
